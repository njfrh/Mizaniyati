...
const rules = [
...

  {
    ...
    replies: [
      "الرصيد الإجمالي هو الرصيد الرئيسي اللي يجمع كل الأرصدة.",
...

{
  ...
  replies: [
    ...
    "العمليات مرتبة حسب التاريخ، والأحدث يظهر فوق."
  ]
},

{
  ...
  replies: [
    "اضغطي زر إضافة المصروف، وادخلي المبلغ، التصنيف، والتعليق وسيتم إضافته تلقائيًا لسجل العمليات.",
